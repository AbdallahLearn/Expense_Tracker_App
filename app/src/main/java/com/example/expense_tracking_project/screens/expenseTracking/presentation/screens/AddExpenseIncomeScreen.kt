...
fun AddExpenseScreen(
    ...
    if (!isAtLeastOreo()) {
        Toast.makeText(
            context,
            "This feature requires Android 8.0 (API 26) or higher",
            Toast.LENGTH_LONG
        ).show()
        return
    }
...
//        FormField(
//            label = stringResource(R.string.expenseAmount),
//            value = expensesAmountState.value
//        ),
//        FormField(
//            label = stringResource(R.string.expenseCategory),
//            value = expensesCategoryState.value
//        ),
//        FormField(
...
//        FormField(
//            label = stringResource(R.string.incomeCategory),
//            value = incomeCategoryState.value
//        ),
//        FormField(
